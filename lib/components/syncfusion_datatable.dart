        ...
        child: SfDataGridTheme(
            ...
            child: Builder(builder: (context) {
              AdminController? controller =
                  DashboardUtils.findController<AdminController>(context);
              if (controller == null) {
              ...
              return SfDataGrid(
                  ...
                  selectionMode: controller.canSelect
                  ...
                  onSelectionChanged: (addedRows, removedRows) {
                    for (var row in addedRows) {
                      DocumentSnapshot selected =
                          (row as SyncfusionDataGridRow).doc;
                  ...
                  onCellTap: (details) {
                    if (details.rowColumnIndex.rowIndex > 0) {
                      SyncfusionDataGridRow row =
                          controller.datagridSource!.effectiveRows[
                                  details.rowColumnIndex.rowIndex - 1]
                              as SyncfusionDataGridRow;
                      DocumentSnapshot doc = row.doc;

                      if (module.selectPreEdit) {
                        print(
                            "selected = ${_controller.selectedIndex} / ${details.rowColumnIndex.rowIndex}");
                  ...
                  columns: controller.columns
                      .map<GridColumn>((col) => GridColumn(
                          ...
                          width: (col.field == '_acciones')
                              ? controller.module.actionColumnWidth ??
                                  double.nan
                              : (controller.columnWidths[col.field] ??
                                  double.nan),
