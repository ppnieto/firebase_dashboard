...
class DashInfiniteListViewStreamBuilder extends StatelessWidget {
  final String? noElementTitle;
  final Widget? noElementWidget;
  final Query query;
  final Widget Function(DocumentSnapshot doc) builder;
  const DashInfiniteListViewStreamBuilder({super.key, required this.query, required this.builder, this.noElementTitle, this.noElementWidget});
